...
public class Location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2164744063833380110L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Location\",\"namespace\":\"bd.shakik.avro.schemas\",\"fields\":[{\"name\":\"lon\",\"type\":\"double\"},{\"name\":\"lat\",\"type\":\"double\"}]}");
   ...
   */
  public static bd.shakik.avro.schemas.Location.Builder newBuilder() {
    return new bd.shakik.avro.schemas.Location.Builder();
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static bd.shakik.avro.schemas.Location.Builder newBuilder(bd.shakik.avro.schemas.Location.Builder other) {
    if (other == null) {
      return new bd.shakik.avro.schemas.Location.Builder();
    } else {
      return new bd.shakik.avro.schemas.Location.Builder(other);
    }
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static bd.shakik.avro.schemas.Location.Builder newBuilder(bd.shakik.avro.schemas.Location other) {
    if (other == null) {
      return new bd.shakik.avro.schemas.Location.Builder();
    } else {
      return new bd.shakik.avro.schemas.Location.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(bd.shakik.avro.schemas.Location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(bd.shakik.avro.schemas.Location other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.lon)) {
        this.lon = data().deepCopy(fields()[0].schema(), other.lon);
    ...
    /**
      ...
      * @return This builder.
      */
    public bd.shakik.avro.schemas.Location.Builder setLon(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public bd.shakik.avro.schemas.Location.Builder clearLon() {
    ...
    /**
      ...
      * @return This builder.
      */
    public bd.shakik.avro.schemas.Location.Builder setLat(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public bd.shakik.avro.schemas.Location.Builder clearLat() {
